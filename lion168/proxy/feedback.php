...
if($action=='save'){
	...
	$dateline=time();
	$insql="INSERT INTO `ek_proxy_feedback` (`uid`,`msg`,dtime)VALUES ('$cfg_cl->M_ID','$msg','$dateline')";
...
$csqlStr="select count(*) as dd from `ek_proxy_feedback` b where uid='$cfg_cl->M_ID' and ischeck='1'";
...
$sqlStr="select b.*,a.name from ek_proxy_feedback b left join ek_admin a on a.id=b.mid where uid='$cfg_cl->M_ID' order by b.dtime desc limit $limitstart,$numPerPage";
...
$t->display('proxy/feedback.html',"$cacheid");