...
if(function_exists("imagecreate"))
{
	...
	$ntime = time();
	if(empty($_SESSION['ek_ckstr_last']) || empty($_SESSION['ek_ckstr']) || ($ntime - $_SESSION['ek_ckstr_last'] > 5))
	{
		$_SESSION['ek_ckstr'] = strtolower($rndstring);
		$_SESSION['ek_ckstr_last'] = $ntime;
	}
	$rndstring = $_SESSION['ek_ckstr'];
