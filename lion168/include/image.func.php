...
{
	include(EK_DATA.'/mark/inc_photowatermark_config.php');
	require_once(EK_INC.'/image.class.php');
	if($photo_markup!='1')
	{
		return;
	}
	...
	if($fromGo=='down' && $photo_markdown=='0')
	{
 	...
 	$trueMarkimg = EK_DATA.'/mark/'.$photo_markimg;
	...
	if($photo_marktype == '2')
	{
	if(file_exists(EK_DATA.'/mark/mtcorsva.ttf'))
	{
		$cfg_watermarktext['fontpath'] =  EK_DATA.'/mark/mtcorsva.ttf';
	}
	else
	{
		return ;
