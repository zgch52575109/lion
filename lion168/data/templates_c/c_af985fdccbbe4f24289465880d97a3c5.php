...
<div class="qt" style="SCROLLBAR-FACE-COLOR:#623313; SCROLLBAR-HIGHLIGHT-COLOR:#2C1D07; OVERFLOW:
auto; SCROLLBAR-SHADOW-COLOR:
COLOR:#000000 ; SCROLLBAR-3DLIGHT-COLOR:#351C0D; SCROLLBAR-ARROW-COLOR:
#300; SCROLLBAR-DARKSHADOW-COLOR: #351C0D; HEIGHT:320px; WIDTH:100%;">
  <table width="96%" align="center"  border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC" style="font-size:12px; line-height:18px;">
  ...
  <tr style="font-size:12px;  text-align:left; line-height:18px;">
    <td width="75%" height="20" bgcolor="#FFFFFF"><?php echo $this->_vars['data']['l_body']; ?>
</td>
    <td width="21%" height="20" bgcolor="#FFFFFF"><?php echo $this->_vars['data']['l_addtime']; ?>
</td>
    </tr>
