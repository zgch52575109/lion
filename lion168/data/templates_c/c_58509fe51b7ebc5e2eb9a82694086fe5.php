...
<div id="maincontent">
  ...
  <div id="rightcontent">
    <div class="tabs">
      <strong>会员中心</strong>
      <ul>
        <li class="current"><a href="#">我的帐户</a></li>
        <li><a href="#">存款</a></li>
        <li><a href="#">取款</a></li>
        <li><a href="#">资金转账</a></li>
        <li><a href="#">交易记录</a></li>           
    ...
    <div id="newaddcontent">
     <div class="title">我的帐户</div>
      <div class="body">
      <ul>
        <li><span>用户名：</span>xxx111</li>
        <li><span>余额</span>￥0.00</li>
        <li><span>Sky133主账户:</span>￥0.00</li>
        <li><span>皇家贵宾厅余额：</span>￥0.00</li>
        <li><span>电子竞技厅月：</span>￥0.00</li>
