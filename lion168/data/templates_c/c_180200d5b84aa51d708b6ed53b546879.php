...
<ul>
<li style="margin:0; background-color:#FEB638"><a href="#">公告</a></li>
...
<div class="qt"  style="OVERFLOW:auto; HEIGHT:338px;WIDTH:auto;">
  <table width="570" align="center"  border="0" cellpadding="0" cellspacing="1" bgcolor="#CCCCCC" style="font-size:12px; text-align:left; line-height:18px;">
  ...
  <tr>
    ...
    <td width="118" height="20" align="center" bgcolor="#FFFFFF"><?php echo $this->_vars['data']['l_addtime']; ?>
</td>
    </tr>
	<?php endforeach; endif; ?>
      <tr>
    <td height="20" colspan="2" align="center" bgcolor="#FEB638" style="color:#000; font-size:12px;">共<?php echo $this->_vars['TotalResult']; ?>
