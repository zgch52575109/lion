...
$csqlStr="select count(*) as dd from `ek_notice` b";
...
$sqlStr="select b.* from ek_notice b order by b.l_addtime desc limit $limitstart,$numPerPage";
...
$t->display('member/notice.html',"$cacheid");