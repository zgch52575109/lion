...
$csqlStr="select count(*) as dd from `ek_awards` b where b.l_expaddtime>'".time()."'";
...
$sqlStr="select b.* from ek_awards b where b.l_expaddtime>'".time()."' order by b.l_addtime desc limit $limitstart,$numPerPage";
...
$t->display('member/winning_information.html',"$cacheid");