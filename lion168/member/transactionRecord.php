...
$searchstr=$_SERVER['QUERY_STRING'];
	...
	$csqlStr="select count(*) as dd from `ek_member_incash` o $whereorder";
	...
	$sqlStr="select o.* from ek_member_incash o ".$whereorder." order by o.addtime desc limit $limitstart,$numPerPage";
...
$t->display('member/transactionRecord.html',"$cacheid");