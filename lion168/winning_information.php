...
$cacheid = "winning_information";
$t->assign('noticear',get_notice_list('1'));

$numPerPage=6;
$page = isset($page) ? intval($page) : 1;

$csqlStr="select count(*) as dd from `ek_awards` b";
...
$sqlStr="select b.* from ek_awards b order by b.l_addtime desc limit $limitstart,$numPerPage";
...
$t->display('winning_information.html',"$cacheid");